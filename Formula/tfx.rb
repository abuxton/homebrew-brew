...
class Tfx < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url 'https://github.com/straubt1/tfx/releases/download/${version}/tfx_darwin_amd64'
    #   sha256 "3f70876616b289eaed6dbdd93333481cec2b8c19c80515bfff4e3dd816cd8a70"
  end

  # if OS.mac? && Hardware::CPU.arm?
  #   url "https://github.com/straubt1/tfx/releases/download/${version}/tfx_linux_arm"
  #   sha256 "3f3e90d39d46e51c3ff40c63d629d00af4025db7b7313faccbb88159d5cca469"
  # end

  if OS.linux? && Hardware::CPU.intel?
    url 'https://github.com/straubt1/tfx/releases/download/${version}/tfx_linux_amd64'
